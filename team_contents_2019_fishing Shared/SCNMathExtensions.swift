...
#if os(macOS)
	#if (arch(x86_64))
		public typealias SCNSimdFloat3 = SIMD3<Double>
	#else
...
func != (l: SCNVector3, r: SCNVector3) -> Bool {
    return !(l==r)
}
...
extension SCNVector3
{
	...
	public func cross(_ other:SCNVector3) -> SCNVector3 {
	...
	public func dot(_ other:SCNVector3) -> SCNFloat {
    ...
    var length : SCNFloat { return self.magnitude() }
	
    public func distance(to:SCNVector3) -> SCNFloat {
    ...
    public static func * (a:SCNFloat, b:SCNVector3) -> SCNVector3 { return b.multiplied(by: a) }
...
extension SCNQuaternion
{
	...
	public init(from a:SCNVector3, to b:SCNVector3, opposing180Axis:SCNVector3=identityUpVector) {
		...
		let dotProduct = aNormal.dot(bNormal)
		if dotProduct >= 1.0 {
			...
			let xyz = aNormal.cross(bNormal) / s
